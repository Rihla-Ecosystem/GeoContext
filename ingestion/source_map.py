...
SOURCE_MAP = {
    ...
    "EgyptSites.geojson": {"model": "Site", "defaults": {"categories": ["archaeological"]}},
    "IslamicSites.geojson": {"model": "Site", "defaults": {"categories": ["islamic"]}},
    "ChristianSites.geojson": {"model": "Site", "defaults": {"categories": ["christian"]}},
